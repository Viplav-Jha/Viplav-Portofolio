          ...
          {!error && messages.length === 0 && (
            <div className="mx-8 flex h-full flex-col items-center justify-center gap-3 text-center">
              ...
              <p className="text-[15px]">
                Currently, we are experiencing a high response volume, and our
            team is actively working to address it.
              </p>
              <p className="text-sm text-muted-foreground">
              In the meantime please feel free to download my resume for more information
                about me.{" "}
                <a
